...
return [
    ...
    'backup' => [
        ...
        /*
        * O diretório de destino real para backups.
        */
        'destination_path' => storage_path('app/backups'), // Defina o diretório desejado para backups
        /*
        * O formato do nome do arquivo de backup.
        * ...
        */
        'destination_file_format' => 'Y-m-d-H-i-s',
    ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('MAIL_BACKUP_TO', 'your@example.com'),
